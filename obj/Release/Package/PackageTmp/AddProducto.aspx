...
BODY {
	BACKGROUND-IMAGE: url(Images/fondo.jpg); BACKGROUND-COLOR: #DF013A
}
                                                                             .auto-style1 {
                                                                                 width: 224px;
                                                                             }
    ...
    <script type="text/javascript" language="javascript">
        ...
        function fnCompraCallback(par) {
            document.getElementById("hdnCompraId").value = par[0]; 
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
    ...
    <tr>
      <td rowspan="2" align="left" valign="top" bgcolor="#37703e" class="auto-style1"><uc1:UCNavigation id="UserControl2" runat="server"></uc1:UCNavigation></td>
    ...
    <tr>
      <td height="30" bgcolor="#d2d2c6" class="auto-style1">&nbsp;</td>
